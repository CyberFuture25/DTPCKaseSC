...
namespace DTPCKase1._4.Migrations
{
    ...
    [Migration("20240630154837_addCompanyToUser")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DTPCKase1._4.Models.CartDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DTPCKase1._4.Models.Categoria", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DTPCKase1._4.Models.Company", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            City = "Lima",
                            Name = "DTPCKase",
                            PhoneNumber = "+51 968452366",
                            PostalCode = "51",
                            State = "Miraflores",
                            StreetAddress = "Av. Santa Cruz 843 - Miraflores"
                        });
                });

            modelBuilder.Entity("DTPCKase1._4.Models.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DTPCKase1._4.Models.OrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DTPCKase1._4.Models.OrderStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DTPCKase1._4.Models.ShoppingCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DTPCKase1._4.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("DTPCKase1._4.Models.CartDetail", b =>
                {
                    b.HasOne("DTPCKase1._4.Models.Producto", "Producto")
                        .WithMany("CartDetail")
                        .HasForeignKey("ProductoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DTPCKase1._4.Models.ShoppingCart", "ShoppingCart")
                        .WithMany()
            ...
            modelBuilder.Entity("DTPCKase1._4.Models.Order", b =>
                {
                    b.HasOne("DTPCKase1._4.Models.OrderStatus", "OrderStatus")
                        .WithMany()
            ...
            modelBuilder.Entity("DTPCKase1._4.Models.OrderDetail", b =>
                {
                    b.HasOne("DTPCKase1._4.Models.Order", "Order")
            ...
            modelBuilder.Entity("DTPCKase1._4.Models.ApplicationUser", b =>
                {
                    b.HasOne("DTPCKase1._4.Models.Company", "Company")
                        .WithMany()
